...
export const streamTabs: { key: StreamKey; label: string; shortLabel: string; icon: typeof GraduationCap; color: string; courses: Course[] }[] = [
  ...
  { key: "paramedical", label: "Para Medical",           shortLabel: "Para Med",   icon: Activity,      color: "teal",   courses: paramedicalCourses },
  { key: "law",         label: "Law Courses",            shortLabel: "Law",        icon: Scale,         color: "purple", courses: lawCourses },
...
export const colorMap: Record<string, {
  ...
  teal: {
    tab: "text-teal-700 border-teal-600 bg-teal-50",
    active: "bg-teal-600",
    ...
    pointBorder: "border-teal-100",
    pointText: "text-teal-800",
    checkColor: "text-teal-500",
  },
  purple: {
    tab: "text-purple-700 border-purple-600 bg-purple-50",
    ...
    accentBar: "from-purple-500 to-violet-500",
    sectionBg: "bg-purple-50/40",
    shadow: "shadow-purple-200",
    pointBorder: "border-purple-100",
    pointText: "text-purple-800",
