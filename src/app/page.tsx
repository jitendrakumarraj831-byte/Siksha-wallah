...
import { ImportantUpdates, EducationPlatform } from "@/components/education-platform";
import {
...
export default function Home() {
  ...
  return (
    <main className="overflow-hidden bg-white text-[#07152f]">
      ...
      <header className="absolute left-0 right-0 z-40 border-b border-white/10 text-white">
        <div className="container-shell flex h-[76px] items-center justify-between">
          ...
          <nav className="hidden items-center gap-7 text-sm font-semibold lg:flex">
            ...
            <a href="#features" className="transition hover:text-[#67c8ff]">Features</a>
      ...
      <section id="process" className="bg-[#07152f] py-24 text-white"><div className="container-shell"><div className="text-center"><p className="mb-3 text-sm font-extrabold uppercase tracking-[.2em] text-[#67c8ff]">Simple, transparent process</p><h2 className="font-display text-4xl font-extrabold sm:text-5xl">From uncertainty to admission.</h2></div><div className="mt-14 grid gap-6 md:grid-cols-4">{[["01","Tell us your goal","Share your interests, marks and preferred budget."],["02","Get your roadmap","Receive shortlisted courses and verified institutions."],["03","Apply with confidence","We organise documents and coordinate applications."],["04","Begin your journey","Complete enrolment with continued support from us."]].map(([n,t,d]) => <div key={n} className="rounded-2xl border border-white/10 bg-white/5 p-6"><span className="font-display text-4xl font-extrabold text-[#67c8ff]">{n}</span><h3 className="mt-8 font-display text-lg font-extrabold">{t}</h3><p className="mt-3 text-sm leading-6 text-slate-400">{d}</p></div>)}</div></div></section>
