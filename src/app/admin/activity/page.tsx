      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-headline text-3xl font-extrabold text-gray-900">Live Activity Log</h1>
          </div>
          <p className="mt-1 text-sm text-gray-500">Real-time log of all website activity — inquiries, registrations, logins, WhatsApp clicks, and more</p>
        </div>
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          ...
          {filterType && (
            <button onClick={() => setFilterType("")} className="rounded-full border border-red-200 bg-red-50 px-3 py-1.5 text-xs font-bold text-red-600 hover:bg-red-100 transition">
              ✕ Clear filter
            </button>
          )}
        </div>
        ...
        <div className="mb-4 flex gap-3">
          <input
            type="text"
            placeholder="Search by name, mobile, email, description..."
            value={search}
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-gray-200 py-16 text-center">
            <p className="font-semibold text-gray-400">No activity found</p>
            <p className="text-sm text-gray-300 mt-1">Activities appear here as visitors use the website</p>
          </div>
        ) : (
          <div className="space-y-2">
            {filtered.map(act => {
              ...
              return (
                <div key={act.id} className="flex items-start gap-4 rounded-2xl border-2 border-gray-100 bg-white px-5 py-4 shadow-sm hover:border-blue-100 transition">
                  {/* Type icon */}
        ...
        <p className="mt-4 text-center text-xs text-gray-400">
          Showing {filtered.length} of {activities.length} total activities • Auto-updates in real-time
        </p>
