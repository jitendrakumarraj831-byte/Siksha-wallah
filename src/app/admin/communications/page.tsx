...
export default function AdminCommunicationsPage() {
  ...
  return (
    <div className="container-shell py-8">
      ...
      <h1 className="mt-8 text-3xl font-extrabold text-slate-900">Send Communications</h1>
      <p className="mt-2 text-slate-600">Send emails and SMS to students</p>

      <div className="mt-8 rounded-xl border bg-white p-8 text-center">
        <p className="text-slate-600">Email and SMS campaign tool coming soon...</p>
      </div>
    </div>
  );
}
