...
export default function ContactPage() {
  const [form, setForm] = useState({ fullName: "", mobile: "", course: "", message: "" });
  ...
  return (
    <PortalShell>
              ...
              {submitted ? (
                <div className="flex flex-col items-center gap-4 py-16 text-center">
                  ...
                  <div className="flex gap-3 mt-2">
                    ...
                    <button onClick={() => { setSubmitted(false); setForm({ fullName: "", mobile: "", course: "", message: "" }); }} className="rounded-xl border-2 border-gray-200 px-5 py-2.5 text-sm font-bold text-gray-700 hover:border-gray-300">
                      New Inquiry
                    </button>
                  </div>
                </div>
                ...
                <>
                  ...
                  <p className="text-gray-500 text-sm mb-6">
                    Form fill करें — Inquiry automatically WhatsApp पर भी जाएगी।
                  </p>
      ...
      <section className="bg-white pb-20">
        <div className="container-shell">
          <div className="rounded-2xl overflow-hidden border-2 border-gray-100 h-64 bg-gray-100 flex items-center justify-center">
            <div className="text-center text-gray-400">
              <MapPin size={40} className="mx-auto mb-3 text-gray-300" />
              <p className="font-bold text-gray-600">College Chowk, Near HP Petrol Pump</p>
              <p className="text-sm">Forbesganj, Araria, Bihar</p>
              <a
                href="https://maps.google.com/?q=Forbesganj+Araria+Bihar"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-[#003f9f] px-5 py-2 text-sm font-bold text-white hover:bg-blue-700 transition"
              >
